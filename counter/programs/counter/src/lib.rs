...
// RUST MACRO ID
declare_id!("Cdspdrazq2FtEw5fzajDN7b8ree2X1yXiBGYkwjP6DH6");
...
pub struct Counter {
    ...
    pub bump: u8,   // 1 byte -> this bump is used for number from the keypair (have private-key) to PDA (not have private-key)
}